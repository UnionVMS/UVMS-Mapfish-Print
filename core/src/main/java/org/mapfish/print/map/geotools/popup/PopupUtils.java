...
/**
 * Created by georgige on 3/23/2016.
 */
public class PopupUtils {
    ...
    public static void topBorderLabel(final Collection<PopupContent> popups, final GeometryFactory geometryFactory,
        ...
        if (intersections.getNumPoints() > 0) {
            ...
            popups.add(new PopupContent("some text", (int) screenPoints[0], (int) screenPoints[1], PopupContent.Side.TOP));
        }
    }
     ...
     */
    // CSOFF: ParameterNumber
    public static void bottomBorderLabel(final Collection<PopupContent> popups, final GeometryFactory geometryFactory,
                                         final Polygon rotatedBounds, final String unit, final double x,
                                         final AffineTransform worldToScreenTransform,
                                         final MathTransform toLabelProjection,
                                         final String labelFormat) {
        ...
        if (intersections.getNumPoints() > 0) {
            ...
            double[] labelProj = transformToLabelProjection(toLabelProjection, borderIntersection);
            popups.add(new PopupContent("some text", (int) screenPoints[0], (int) screenPoints[1], PopupContent.Side.BOTTOM));
        }
    }
    // CSON: ParameterNumber
     ...
     */
    // CSOFF: ParameterNumber
    public static void rightBorderLabel(final Collection<PopupContent> popups, final GeometryFactory geometryFactory,
        ...
        if (intersections.getNumPoints() > 0) {
            ...
            double[] labelProj = transformToLabelProjection(toLabelProjection, borderIntersection);
            popups.add(new PopupContent("some text", (int) screenPoints[0], (int) screenPoints[1], PopupContent.Side.RIGHT));
        }
    }
    // CSON: ParameterNumber
     ...
     */
    // CSOFF: ParameterNumber
    static void leftBorderLabel(final Collection<PopupContent> popups, final GeometryFactory geometryFactory,
                                final Polygon rotatedBounds, final String unit, final double y,
                                final AffineTransform worldToScreenTransform,
                                final MathTransform toLabelProjection,
                                final String labelFormat) {
        ...
        if (intersections.getNumPoints() > 0) {
            ...
            popups.add(new PopupContent("some text", (int) screenPoints[0], (int) screenPoints[1], PopupContent.Side.LEFT));
        }
    }
    // CSON: ParameterNumber
